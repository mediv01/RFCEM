...
enum RFCECivCountry {
	...
	iAragon, Civ_Sweden, Civ_Prussia, Civ_Lithuania, Civ_Austria, Civ_Turkey, Civ_Moscow, Civ_Dutch, Civ_Pope, Civ_Independent1, Civ_Independent2, Civ_Independent3, Civ_Independent4, Civ_Barbarian
};
