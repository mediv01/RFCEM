...
tArabiaControlII = [ xml.iP_Algiers, xml.iP_Ifriqiya, xml.iP_Cyrenaica, xml.iP_Tripolitania, xml.iP_Egypt, xml.iP_Antiochia, xml.iP_Syria, xml.iP_Lebanon, xml.iP_Arabia, xml.iP_Jerusalem]
...
#####################################
	...
	def checkDenmark(self, iGameTurn):
		...
		# UHV 1: Control Denmark, Skaneland, G鰐aland, Svealand, Mercia, London, Northumbria and East Anglia in 1050
		...
		# UHV 2: Control Denmark, Norway, Vestfold, Skaneland, G鰐aland, Svealand, Norrland, Gotland, 謘terland, Estonia and Iceland in 1523
